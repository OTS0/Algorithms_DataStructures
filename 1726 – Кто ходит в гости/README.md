...
Исходные данные
Первая строка содержит целое число n — количество членов программного комитета (2 ≤ n ≤ 10^5). В i-й из следующих n строк через пробел записаны целые числа x_i, y_i — координаты дома i-го члена программного комитета (1 ≤ x_i, y_i ≤ 10^6).
